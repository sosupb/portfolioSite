	...
	<body>
		...
		<div class="header">
  			...
  			<div class="header-right">
    			...
    			<a href="<?echo $navService->moveToContactPage();?>" class="<?echo $navService->getButtonClass($navService->moveToContactPage());?>" >Contact</a>
    			<a href="<?echo $navService->moveToAboutPage();?>" class="<?echo $navService->getButtonClass($navService->moveToAboutPage());?>" >About</a>
  			</div>
		</div>
